...
# Filter data for patients with successful transplant (failure == 0)
...
polygon(c(rev(gridPoints), gridPoints), c(rev(ci_beta_0_lower), ci_beta_0_upper), col = "cornflowerblue", border = NA)
...
polygon(c(rev(gridPoints), gridPoints), c(rev(ci_beta_1_lower), ci_beta_1_upper), col = "cornflowerblue", border = NA)
lines(gridPoints, beta_1, lty = 1, col = "black", lwd = 4)
abline(h = 0)
title("Proteinuria")

plot(gridPoints, beta_2, type = "l", lwd = 4, ylab = expression(hat(beta)[2](t)), xlab = "Years since transplant", xaxs = "i", yaxs = "i", ylim = range(ci_beta_2_lower - 0.7, ci_beta_2_upper))
polygon(c(rev(gridPoints), gridPoints), c(rev(ci_beta_2_lower), ci_beta_2_upper), col = "cornflowerblue", border = NA)
lines(gridPoints, beta_2, lty = 1, col = "black", lwd = 4)
abline(h = 0)
title("Hematocrit")

plot(gridPoints, beta_3, type = "l", lwd = 4, ylab = expression(hat(beta)[3](t)), xlab = "Years since transplant", xaxs = "i", yaxs = "i", ylim = range(ci_beta_3_lower - 0.4, ci_beta_3_upper))
polygon(c(rev(gridPoints), gridPoints), c(rev(ci_beta_3_lower), ci_beta_3_upper), col = "cornflowerblue", border = NA)
...
polygon(c(rev(gridPoints), gridPoints), c(rev(ci_beta_4_lower), ci_beta_4_upper), col = "cornflowerblue", border = NA)
...
polygon(c(rev(gridPoints), gridPoints), c(rev(ci_beta_5_lower), ci_beta_5_upper), col = "cornflowerblue", border = NA)
